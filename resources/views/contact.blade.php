...
@section('content')
    ...
    <div class="relative w-full h-[400px] overflow-hidden">
        <img src="{{ asset('img/contact/hero.webp') }}" class="absolute inset-0 w-full h-full object-cover">
         <div class="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-4">
             <span class="text-brand font-bold uppercase tracking-widest text-sm mb-2 bg-white/20 px-3 py-1 rounded-full backdrop-blur-sm text-sand border border-white/30">Get in Touch</span>
             <h1 class="text-4xl md:text-6xl text-white font-bold font-display mb-4 drop-shadow-lg">We'd Love to Hear From You</h1>
