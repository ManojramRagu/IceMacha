                                    ...
                                    <div class="flex items-center gap-6">
                                        ...
                                        <div class="flex items-center bg-gray-100 rounded-xl p-1.5">
                                            <button wire:click="decrement({{ $item->CartItemId }})" 
                                                    class="w-12 h-12 flex items-center justify-center text-gray-500 hover:text-brand hover:bg-white rounded-lg transition-all disabled:opacity-30 disabled:cursor-not-allowed" 
                                        ...
                                        <button wire:click="removeItem({{ $item->CartItemId }})" 
                                                class="w-12 h-12 flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all" 
                                                title="Remove">
